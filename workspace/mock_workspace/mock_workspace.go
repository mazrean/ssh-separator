...
//
//	mockgen -source=workspace.go -destination=mock_workspace/mock_workspace.go
//
...
func (mr *MockIWorkspaceMockRecorder) Create(ctx, userName any) *gomock.Call {
...
func (mr *MockIWorkspaceMockRecorder) Recreate(ctx, workspace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIWorkspaceMockRecorder) Start(ctx, workspace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIWorkspaceMockRecorder) Stop(ctx, workspace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
