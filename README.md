...
|MAX_TOTAL_CONNECTIONS|Maximum number of simultaneous SSH connections allowed globally.|100|
|MAX_CONNECTIONS_PER_USER|Maximum number of simultaneous SSH connections allowed per user.|10|
