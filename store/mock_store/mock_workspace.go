...
//
//	mockgen -source=workspace.go -destination=mock_store/mock_workspace.go
//
...
func (mr *MockIWorkspaceMockRecorder) Get(ctx, userName any) *gomock.Call {
...
func (mr *MockIWorkspaceMockRecorder) Set(ctx, userName, workspace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
