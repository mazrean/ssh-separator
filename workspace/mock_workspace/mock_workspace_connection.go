...
//
//	mockgen -source=workspace_connection.go -destination=mock_workspace/mock_workspace_connection.go
//
...
func (mr *MockIWorkspaceConnectionMockRecorder) Connect(ctx, workspace any) *gomock.Call {
...
func (mr *MockIWorkspaceConnectionMockRecorder) Disconnect(ctx, connection any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIWorkspaceConnectionMockRecorder) Resize(ctx, connection, window any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
